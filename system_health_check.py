...
class DjinnSystemHealthCheck:
    ...
    def check_ollama_installation(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.health_report['issues'].append("Ollama not installed or not in PATH")
    ...
    def check_ollama_service(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.health_report['issues'].append("Start Ollama service: ollama serve")
    ...
    def check_required_models(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if missing_models:
                    self.health_report['issues'].append(f"Missing models: {', '.join(missing_models)}")
                    self.health_report['recommendations'].append("Run: ./setup_djinn_federation.bat")
    ...
    def check_system_resources(self):
        ...
        try:
            ...
            ram_score = min(100, int((memory.available / (1024**3)) / 8 * 100))  # 8GB baseline
            cpu_score = max(0, 100 - cpu_percent)
            disk_score = min(100, int((disk.free / (1024**3)) / 10 * 100))  # 10GB baseline
            ...
            if overall_resource_score < 50:
                self.health_report['issues'].append("Low system resources - consider closing other applications")
    ...
    def check_enhanced_systems(self):
        ...
        if failed_modules:
            self.health_report['issues'].append(f"Enhanced systems missing: {', '.join(failed_modules)}")
