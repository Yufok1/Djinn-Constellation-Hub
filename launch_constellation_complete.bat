...
if %errorlevel% neq 0 (
    echo ⚠️  Constellation Hub not found - installing...
...
if %errorlevel% neq 0 (
    echo ⚠️  Council Model not found - installing...
...
if %errorlevel% neq 0 (
    echo ⚠️  IDHHC Model not found - installing...
...
if %errorlevel% neq 0 (
    echo ⚠️  Companion Model not found - installing...
...
if exist "void_workspace" (
    ...
    echo ⚠️  Void Framework not found - will initialize
)
...
if exist "memory_bank" (
    ...
    echo ⚠️  Memory Bank not found - will initialize
    mkdir memory_bank
)
...
if exist "bridge" (
    ...
    echo ⚠️  Bridge Systems not found - will initialize
    mkdir bridge
)
